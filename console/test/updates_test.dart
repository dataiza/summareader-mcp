...
void main() {
  ...
  group('the two spellings of the entry', () {
    ...
    test('what is installed says the same as what is in the image', () async {
      ...
      // (scripts/appimage/sk.dataiza.summareader_mcp_console.desktop) and the one
      ...
      final written = File(
        '${home.path}/.local/share/applications/sk.dataiza.summareader_mcp_console.desktop',
      ).readAsLinesSync();
      final packed = File(
        '../scripts/appimage/sk.dataiza.summareader_mcp_console.desktop',
      ).readAsLinesSync();
