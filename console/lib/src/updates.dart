...
/// again, and nobody thinks to look again. The mirror's protocol moves, feeds
/// change what they serve, and a console a year behind reports those as bugs.
///
...
class GitHubUpdates implements Updates {
  const GitHubUpdates({
    this.repository = 'dataiza/summareader-mcp',
    this.client,
  });
